...
func TestDA1(t *testing.T) {
	got := RespondToDecQueries([]byte("\x1b[c"))
...
func TestDSRCursor(t *testing.T) {
	got := RespondToDecQueries([]byte("\x1b[6n"))
...
func TestXTVersion(t *testing.T) {
	got := RespondToDecQueries([]byte("\x1b[>q"))
...
func TestWindowSize(t *testing.T) {
	got := RespondToDecQueries([]byte("\x1b[18t"))
...
func TestIgnoresPlainText(t *testing.T) {
	if got := RespondToDecQueries([]byte("hello world without esc")); len(got) != 0 {
		t.Fatalf("expected empty, got %q", got)
	}
}

func TestMultipleQueriesInOneChunk(t *testing.T) {
	got := RespondToDecQueries([]byte("hi\x1b[cthere\x1b[>cyo"))
...
func TestOtherCSIIgnored(t *testing.T) {
	...
	if got := RespondToDecQueries([]byte("\x1b[1C\x1b[38;5;208m\x1b[2J")); len(got) != 0 {
		t.Fatalf("expected empty, got %q", got)
	}
}
